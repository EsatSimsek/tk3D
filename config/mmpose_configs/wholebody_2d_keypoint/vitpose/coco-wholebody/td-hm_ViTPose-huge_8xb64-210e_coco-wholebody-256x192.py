...
# TK3D ViTPose-Huge whole-body config for MMPose 1.x.
# It mirrors the MMPose 1.x ViTPose-Huge top-down style while preserving the
# COCO-WholeBody 133-keypoint contract used by the TK3D 3D pipeline.
